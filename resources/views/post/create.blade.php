      ...
      <div class="card-body">
        <form action="{{Route('post.store')}}" enctype="multipart/form-data" method="post">
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <select class="form-control select2 @error('category_id') is-invalid @enderror" style="width:100%;" name="category_id" required>
                <option selected disabled>Select Category's</option>
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <select multiple class="form-control select2 @error('tags') is-invalid @enderror" name="tags[]" style="width:100%;" required>
                @foreach ($tags as $tag)
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <button type="submit" class="form-control btn btn-primary">Create Post <i class="fas fa-fw fa-paper-plane"></i></button>
            </div>
          </div>
        </form>
      </div>
